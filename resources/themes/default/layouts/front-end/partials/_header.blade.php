...
<header class="rtl __inline-10">
    <!--    MG CODE     -->
    <div id="mg-loader" style="position: fixed;width: 100%;height: 100%;display: flex;align-items: center;justify-content: center;z-index: 1000001;background-color: #fff;">
        <img src="/public/assets/front-end/img/loader.gif" alt="loading" />
    </div>
    ...
    <script>
        window.addEventListener("load",function(){
            const pageLoader = document.getElementById("mg-loader");
            pageLoader.className = "hidden";
        })
    </script>
    <!--    MG CODE     -->
    <div class="topbar d-none d-sm-flex">
        <div class="container">
            <div>
