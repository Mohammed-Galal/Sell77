<style>
    div.active.bg-white.pb-3.product-details-sticky.product-details-sticky-section.pt-4.pt-md-3 {
...
<div class="bg-white product-details-sticky product-details-sticky-section pt-4 pt-md-3 pb-3 {{ $productDetails->variation && count(json_decode($productDetails->variation)) > 0 ? 'multi-variation-product' : '' }}" style="bottom: var(--mobile-nav, 0);">
